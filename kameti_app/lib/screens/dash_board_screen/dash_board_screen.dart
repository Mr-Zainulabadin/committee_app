...
class _HomePageState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return Consumer<BottomNavProvider>(builder: (context, bottomProvider, child) {
      return PopScope(
        canPop: false,
        onPopInvoked: (didPop) {
          bottomProvider.selectedIndex != 0 ? bottomProvider.changeSelectedIndex(0) : SystemNavigator.pop();
        },
        child: Scaffold(
